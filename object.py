...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = "C:/Users/PRANJALI SAXENA/Desktop/Django programming/Major_Project/video-ai-327613-da0990a26e67.json"
...
gcs_uri = 'gs://vid-store/default_storage/*'
...
for i, entity in enumerate(result.annotation_results):
    object_annotations = result.annotation_results[i].object_annotations
